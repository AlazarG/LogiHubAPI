package net.logihub.admin.repository;

import net.logihub.admin.LogiHubApiApp;
import net.logihub.admin.config.Constants;
import net.logihub.admin.config.audit.AuditEventConverter;
import net.logihub.admin.domain.PersistentAuditEvent;
...
import static net.logihub.admin.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
