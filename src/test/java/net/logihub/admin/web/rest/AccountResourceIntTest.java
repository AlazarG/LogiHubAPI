...
import net.logihub.admin.repository.AuthorityRepository;
...
import net.logihub.admin.service.dto.PasswordChangeDTO;
import net.logihub.admin.web.rest.errors.ExceptionTranslator;
import net.logihub.admin.web.rest.vm.KeyAndPasswordVM;
